...
const ServiceCardMui: React.FC<{ service: Service, username: string, avatar?: string, onViewDetails: (service: Service) => void }> = ({ service, avatar, username, onViewDetails }) => {
        ...
        <Fade in timeout={500}>
            <Card
                sx={{
                    ...
                    filter: (!service.active || service.visible === false) ? 'grayscale(60%)' : 'none',
                }}
            >
                ...
                <CardContent sx={{ flexGrow: 1, pb: 0, cursor: 'default' }}>
                    <Tooltip title={service.title} placement="top">
                        <Typography gutterBottom variant="h6" noWrap component="div" onClick={(e) => { e.stopPropagation(); onViewDetails(service); }} sx={{ cursor: 'pointer' }}>
                            {service.title}
                        </Typography>
                    </Tooltip>
                    ...
                    <Stack direction="row" spacing={0.5} sx={{ mt: 1, mb: 1, flexWrap: 'wrap', gap: 0.5 }}>
                        ...
                        {service.isLocal &&
                            <Chip
                                ...
                                label={service.location ? `${service.location.substring(0, 15)}${service.location.length > 15 ? '…' : ''}` : "Local"}
                                size="small"
                                variant="outlined"
                        ...
                        {service.productionTime &&
                            <Chip label={service.productionTime} size="small" variant="outlined" />
                        }
                    </Stack>
                ...
                <CardActions sx={{ justifyContent: 'space-between', alignItems: 'center', p: 2, pt: 1, cursor: 'default' }}>
                    <Button
                        size="small"
                        onClick={goToPrixer}
                        startIcon={
