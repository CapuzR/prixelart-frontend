...
var StylesContext = React15.createContext(defaultOptions);
if (true) {
...
function useSynchronousEffect(func, values) {
  const key = React16.useRef([]);
  let output;
  const currentKey = React16.useMemo(() => ({}), values);
...
function makeStyles(stylesOrCreator, options = {}) {
  ...
  const useStyles = (props = {}) => {
    ...
    const stylesOptions = {
      ...React16.useContext(StylesContext),
      ...stylesOptions2
    };
    const instance = React16.useRef();
    const shouldUpdate = React16.useRef();
...
var ServerStyleSheets = class {
  ...
  getStyleElement(props) {
    return React17.createElement("style", {
      id: "jss-server-side",
      key: "jss-server-side",
...
function styled(Component) {
  const componentCreator = (style, options = {}) => {
    ...
    const StyledComponent = React18.forwardRef(function StyledComponent2(props, ref) {
      const {
        children,
    ...
    true ? StyledComponent.propTypes = {
       ...
       */
      clone: chainPropTypes(import_prop_types5.default.bool, (props) => {
...
var withStyles = (stylesOrCreator, options = {}) => (Component) => {
  ...
  const WithStyles = React19.forwardRef(function WithStyles2(props, ref) {
    const {
      classes: classesProp,
      ...other
    } = props;
...
function withThemeCreator(options = {}) {
  ...
  const withTheme2 = (Component) => {
    ...
    const WithTheme = React20.forwardRef(function WithTheme2(props, ref) {
      const theme = useTheme2() || defaultTheme;
