...
const Home: React.FC = () => {
  ...
  const handleProductCatalog = (e: React.MouseEvent<HTMLButtonElement>): void => {
    e.preventDefault();
    navigate('/productos');
  };
                ...
                >
                  <div
                    style={{
                      ...
                      alignItems: 'end',
                      borderRadius: (isDesktop && 47) || (isMobile && 30) || (isTab && 35) || 35,
                    }}
                  >
                    <Typography
                      variant="h3"
                      style={{
                        color: 'white',
                        marginBottom: 12,
                        fontSize: (isDesktop && 30) || (isMobile && 12) || (isTab && 18) || 18,
                      }}
                      fontWeight="bold"
                    >
                    ...
                    <Typography
                      style={{
                        color: '#b7bcc1',
                        textAlign: (isDesktop && 'start') || ((isMobile || isTab) && 'end') || 'start',
                        marginBottom: 12,
                        fontSize: (isDesktop && 20) || (isMobile && 8) || (isTab && 14) || 14,
                        marginLeft: '140px',
                      }}
                    >
                  ...
                  {bestSellers && (
                    <div
                      style={{
                        ...
                        position: 'relative',
                        width: '100%',
                        height: (isDesktop && 450) || (isMobile && 390) || (isTab && 235) || 235,
                        marginLeft: 10,
              ...
              {mostSelledArts && (
                <Paper
                  style={{
                    ...
                    position: 'relative',
                    width: '100%',
                    height: (isDesktop && 450) || (isMobile && 500) || (isTab && 380) || 380,
                    borderRadius: getBorderRadius(),
                    backgroundColor: 'gainsboro',
                    padding: '1rem',
                    paddingBottom: '3rem',
                ...
                >
                  ...
                  >
                    <div
                      style={{
                        ...
                        gap: '1rem',
                        alignItems: 'center',
                        paddingLeft: (isDesktop && 40) || (isMobile && 5) || (isTab && 20) || 20,
                      }}
                    >
                      <Typography
                        variant="h4"
                    ...
                    <div
                      style={{
                        backgroundImage: `linear-gradient(to left, transparent, rgba(64, 78, 92,1)), url(${mostSelledArts[0]?.largeThumbUrl || mostSelledArts[0]?.imageUrl
                          })`,
                        backgroundSize: 'cover',
                        backgroundRepeat: 'no-repeat',
                  ...
                  <Slider
                    images={mostSelledArts?.map((art) => ({
                      url: art?.largeThumbUrl ? art?.largeThumbUrl : art?.imageUrl,
                    }))}
                    useIndicators={{
                      type: 'dots',
                      position: 'below',
              ...
              {latestArts && (
                ...
                >
                  ...
                  >
                    <div
                      style={{
                        backgroundImage: `linear-gradient(to right, transparent, rgba(64, 78, 92,1)), url(${latestArts[1]?.largeThumbUrl || latestArts[1]?.imageUrl
                          })`,
                        backgroundSize: 'cover',
                        backgroundRepeat: 'no-repeat',
                        backgroundPosition: 'left',
                    ...
                    <div
                      style={{
                        ...
                        // alignItems: "center",
                        justifyContent: 'end',
                        paddingRight: (isDesktop && 40) || (isMobile && 5) || (isTab && 20) || 20,
                      }}
                    >
                      <Typography
                        variant="h4"
                  ...
                  <Grid2
                    style={{
                      ...
                      height: (isDesktop && 490) || (isMobile && 450) || (isTab && 490) || 490,
                      marginLeft: 20,
                  ...
                  >
                    ...
                    >
                      {latestArts.map((art) => {
                        const artUrl = art?.largeThumbUrl ? art?.largeThumbUrl : art?.imageUrl;
                        return (
                          <Image
                            src={artUrl}
                            roundedCorner={false}
