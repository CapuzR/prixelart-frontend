      ...
      <div style={{ position: 'relative' }}>
        {productEdit && (
          <div style={{ position: 'absolute', right: 0, top: 16 }}>
            ...
            {(props.permissions?.createProduct || props.permissions?.createDiscount) && (
              <Fab
                color="primary"
                aria-label="add"
                onClick={() => {
        ...
        <Grid container spacing={3} style={{ margin: isDesktop ? '10px' : '', height: '100%' }}>
          <Grid item xs={12} md={12} lg={12}>
            <Paper className={fixedHeightPaper}>
              {activeCrud === 'create' ? (
                ...
                activeCrud === 'updateSurcharge' && <UpdateSurcharge surcharge={surcharge} />
              )}
            </Paper>
          </Grid>
        </Grid>
