...
const Portrait: React.FC<PortraitProps> = (props) => {
  ...
  const isOptionSelected = Array.isArray(props.product.selection)
                ...
                <Select
                  ...
                  value={
                    (props.product?.selection &&
                      props.product?.selection.attributes.value.concat().toString()) ||
                    undefined
                  }
        ...
        <Button
          ...
          disabled={
            (props.product?.selection &&
              ...
              Object.keys(props.product.selection).every(
                (el: string) => el === ""
              )) ||
      ...
      <div className={styles["info-accordion-wrapper"]}>
        ...
        >
          ...
          <AccordionDetails>
            <MDEditor.Markdown
              source={
                props.product?.observations || "No observations available."
              }
              className={styles["markdown-content"]}
            />
          </AccordionDetails>
