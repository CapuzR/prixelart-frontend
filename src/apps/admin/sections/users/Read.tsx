...
const ReadUsers: React.FC = () => {
  ...
  const headCells: readonly HeadCell[] = [
    ...
    },
    {
      ...
      label: "Nombre",
      width: "25%",
    }, // Sorting by firstName, displays full name
    {
      id: "email",
      numeric: false,
      disablePadding: false,
    ...
    <>
      ...
      {error && !isLoading && users.length === 0 && (
        <Alert severity="error" sx={{ m: 2 }}>
          {error}
          <Button onClick={() => loadUsers()} size="small">
            Reintentar
          </Button>
        </Alert>
      )}
      ...
      {!isLoading &&
        ...
        (users.length > 0 ||
          ...
          filters.type !== "all") && (
          <Alert severity="info" sx={{ m: 2 }}>
            No hay usuarios que coincidan con la búsqueda o filtros aplicados.
          </Alert>
        )}
            ...
            <Table stickyHeader sx={{ minWidth: 900 }} aria-label="users table">
              <TableHead>
                ...
                >
                  ...
                  <TableCell sx={{ width: "15%" }}>Rol(es)</TableCell>{" "}
                  {/* Adjusted width */}
                ...
                {processedUsers.map((user) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <Chip
                        icon={
                          user.active ? <CheckCircleIcon /> : <CancelIcon />
                        }
                      ...
                      >
                        <Tooltip title="Editar">
                          <IconButton
                            aria-label="edit"
                            color="primary"
                            onClick={() => handleUpdate(user._id!.toString())}
                            disabled={!user._id || isDeleting}
                            size="small"
                          >
