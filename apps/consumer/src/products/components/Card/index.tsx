...
import { formatNumberString, formatRange } from "@prixpon/utils/formats";
import { Slider } from "components/Slider";
import { Image } from "components/Image";
import { generateWaProductMessage } from "@prixpon/utils";
      ...
      <Grid2 size={{ xs: 12 }} className={styles["buttons-wrapper"]}>
        ...
        <Button
          ...
          onClick={() => {
            ...
            window.open(generateWaProductMessage(product, url), "_blank");
          }}
        >
          <WhatsApp /> Info
        </Button>
