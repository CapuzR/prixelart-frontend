...
describe("with valid input values", () => {
  it("Inputting form login input states works correctly", () => {
    ...
    fireEvent.change(username, {
      target: { value: "rcapuz", textContent: "rcapuz" },
    });
    fireEvent.change(firstName, {
      target: { value: "Ricardo", textContent: "Ricardo" },
    });
    fireEvent.change(lastName, {
      target: { value: "Capuz", textContent: "Capuz" },
    });
    fireEvent.change(email, {
      target: {
        value: "rcapuz@prixelart.com",
        textContent: "rcapuz@prixelart.com",
      },
    });
  ...
  it("username already registered", async () => {
    ...
    expect(
      screen.getByText("Disculpa, el nombre de usuario ya está registrado.")
    ).toBeTruthy();
  });
  ...
  it("email already registered", async () => {
    ...
    expect(
      screen.getByText("Disculpa, el correo del usuario ya está registrado.")
    ).toBeTruthy();
  });
  ...
  it("renders snackbar with success message", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.queryByText("Registro de usuario exitoso.")
      ).toBeInTheDocument();
    });
  });
});
