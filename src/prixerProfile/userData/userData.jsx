...
export default function UserData(props) {
  ...
  const handleChange = (e) => {
    ...
    //setSpecialtyArt([specialtyArt, e.target.value]);
  };
        ...
        <Grid container spacing={1}>
          ...
          {prixerDataState === "read" && (
            <Grid container item xs={12}>
              <Grid item container spacing={2} xs={isDesktop ? 3 : 12}>
                <Grid
                  item
                  xs={isDesktop ? 12 : 12}
              ...
              <Grid item style={{ paddingLeft: 30, paddingBottom: 30 }}>
                {avatarObj ? (
          ...
          {prixerDataState === "edit" && (
            <Grid item xs={12} container>
              <Grid item container direction="column" xs={isDesktop ? 3 : 12}>
              ...
              <Grid
                item
                xs={6}
                style={{ paddingLeft: "25px", paddingBottom: 20 }}
              >
                <TextField
                  style={{ width: "100%" }}
                  id="description"
              ...
              <Grid item style={{ paddingLeft: "25px", paddingBottom: 20 }}>
                {avatarObj ? (
                  <Avatar className={classes.avatar}>
                    <label htmlFor="file-input">
                      <img
