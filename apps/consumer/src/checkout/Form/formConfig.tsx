    ...
    basic: {
      ...
      fields: {
        ...
        phone: {
          label: "Teléfono",
          errorCheck: (value) =>
            /^(?=(?:\D*\d){10,14}$)(?:(\+\d{1,3}\s?\d+)|(0\d+))$/.test(value),
    ...
    shipping: {
      ...
      fields: {
        ...
        name: {
          ...
          hiddingConditions: [
            (methodSelected: string) => isPickup(methodSelected),
          ],
          requiredConditions: [
            (methodSelected: string) => isPickup(methodSelected),
          ],
        ...
        lastName: {
          ...
          width: 6,
          conditionedBy: "shipping.shippingEqualsBasic",
          onConditionChange: createMirrorHandler(
            "shipping.lastName",
            "basic.lastName",
          ),
          hiddingConditions: [
