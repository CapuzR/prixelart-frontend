      ...
      <Grid container spacing={2}>
          ...
          <Grid container>
            <Grid item xs={12}>
              <Checkbox
                ...
                onChange={(e) => {
                  onChangeOrderBasics(e.target.id, e.target.checked);
                }}
              />{" "}
              Vendido por Prixer
            </Grid>
        ...
        <Grid item xs={12} md={4}>
          <FormControl style={{ minWidth: "100%" }} variant="outlined">
            <InputLabel required id="orderType">
              Tipo
            </InputLabel>
            <Select
              labelId="orderType"
        ...
        <Grid item xs={12} md={4}>
          <FormControl
            ...
            md={12}
          >
            <InputLabel required id="generalProductionStatus">
        ...
        <Grid item xs={12} md={4}>
          <FormControl
            ...
            md={12}
          >
            <InputLabel required id="shippingStatus">
              Estatus de envío
            </InputLabel>
            <Select
        ...
        <Grid item xs={12} md={4}>
          ...
          >
            <Autocomplete
              ...
              // options={
              //   props.orderState.selectedOrder.consumers || [
              //     "Buscar consumidor",
              //   ]
              // }
        ...
        <Grid item xs={12} md={4}>
          <FormControl variant="outlined" xs={12} fullWidth={true}>
            <TextField
              ...
              onChange={(e) => {
                onChangeOrderBasics(e.target.id, e.target.value);
              }}
            />
          </FormControl>
        </Grid>
