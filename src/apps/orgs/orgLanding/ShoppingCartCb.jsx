...
export default function shoppingCartCb() {
  ...
  const CustomStepIcon = ({ active }) => {
    ...
    return <StepIcon icon={active ? <div className={classes.stepIcon}>✔️</div> : null} />;
  };
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Button onClick={handleMain}>
            <img src={CB_isologo} alt="Chiguire Bipolar isologo" style={{ width: 238 }} />
          </Button>
      ...
      >
        <Grid item sm={12} md={7} style={{ marginRight: isTab && 10, width: '100%' }}>
          <Typography
            className={classes.typography}
            style={{
      ...
      <Modal open={openModal} onClose={handleClose} className={classes.modal}>
        <Grid container className={classes.paper2} style={{ width: isMobile && '80%' }}>
          ...
          >
            ...
            <div>
              ...
              <Typography className={classes.typography} style={{ fontSize: 16 }}>
                <strong>¡Felicidades!</strong> Tu compra ha sido todo un éxito...
              </Typography>
              <Typography className={classes.typography} style={{ fontSize: 16 }}>
