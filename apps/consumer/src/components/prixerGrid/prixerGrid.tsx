  ...
  useEffect(() => {
    ...
    fetchAllPrixersActive()
      ...
      .catch((apiError) => {
        ...
        setError(
          "We couldn't load the Prixers at this time. Please try again later.",
        );
      })
              ...
              >
                ...
                >
                  ...
                  {(tile.prixer!.specialty ?? []).length > 3 && (
                    <Chip
                      label={`+${(tile.prixer!.specialty ?? []).length - 3}`}
                      size="small"
                    />
                  )}
                </Box>
