...
var useParsedFormat = (parameters = {}) => {
  ...
  const localizedDigits = React11.useMemo(() => getLocalizedDigits(adapter), [adapter]);
  const {
...
function PickersSection(props) {
  ...
  const sectionContentRef = React40.useRef(null);
...
function useMeridiemMode(date, ampm, onChange, selectionState) {
  const adapter = usePickerAdapter();
  const cleanDate = React62.useMemo(() => !adapter.isValid(date) ? null : date, [adapter, date]);
...
//# sourceMappingURL=chunk-7IOBT7H7.js.map
