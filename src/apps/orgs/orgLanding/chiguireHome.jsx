...
export default function ChiguireHome() {
  ...
  const addItemToBuyState = (input) => {
    ...
    const prevItem = newState.find((item) => item.product.item === input.product.item);
  ...
  return (
    <div>
        ...
        >
          <div className={classes.backgroundImage}>
            {!isTab && (
              ...
              >
                <Fab className={classes.fabButton} onClick={() => scrollToSection('#prods')}>
                  <ExpandMore />
                </Fab>
              </Toolbar>
            )}
      ...
      <AppBar position="fixed" elevation={0} style={{ backgroundColor: '#006134', zIndex: 10000 }}>
        <Toolbar
          style={{
            display: 'flex',
            width: '100%',
        ...
        >
          ...
          {isTab ? (
            <>
              <IconButton onClick={handleMenu} style={{ color: 'white' }} size="medium">
      ...
      >
        ...
        >
          ...
          >
            Nos emociona muchísimo compartir con ustedes esta colección exclusiva de merch, hecha en
            alianza con nuestros panas de Prixelart, para que demuestres tu amor por nuestro Chigüi.
            Tenemos franelas, tazas, tote bags y termos con diseños exclusivos para ti. No importa
            si nos sigues desde los tiempos en los que María Alejandra López le tenía fe a Capriles
            o si justo acabas de descubrirnos: seguro encontrarás algo para ti. <br />
            <br /> Con cada compra podrás demostrarle al mundo que para ti, las noticias son un
            asunto muy serio y, al mismo tiempo, apoyas nuestra explotación laboral al pasante
