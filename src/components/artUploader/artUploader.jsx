    ...
    <div>
      ...
      >
        <Backdrop className={classes.backdrop} open={backdrop}>
          ...
          <p>
            Esto puede tardar unos pocos minutos <br /> no cierres esta ventana aún.
          </p>
        </Backdrop>
              ...
              <Grid container spacing={2}>
                ...
                {artType !== 'Diseño' && (
                  <React.Fragment>
                    ...
                    <Grid item container xs={12}>
                      <Grid item xs={6} sm={6} style={{ marginRight: '10px' }}>
                        <TextField
                          variant="outlined"
                          fullWidth
                          required={requiredPhoto}
                      ...
                      <Grid item xs={6} sm={6}>
                        <FormControl
                          ...
                          md={12}
                        >
                          <InputLabel required={requiredPhoto} id="originalPhotoIsoLabel">
                            ISO
                          </InputLabel>
                          <Select
                  ...
                  <Grid container spacing={2} style={{ justifyContent: 'center' }}>
                    <Grid item xs={12} sm={12} md={5}>
                      <FormControl variant="outlined" className={classes.form}>
                        ...
                        <Select value={exclusive} onChange={handleExclusive} label="artType">
