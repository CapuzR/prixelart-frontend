        ...
        <form onSubmit={handleSubmit} noValidate>
          <Grid2 container spacing={3}>
                ...
                <Grid2 container spacing={3}>
                  ...
                  <Grid2 size={{ xs: 12 }}>
                    <Autocomplete
                      ...
                      value={prixerFormData.specialty || []}
                      onChange={handleSpecialtyChange}
                      disableCloseOnSelect
                      freeSolo={false} // Assuming fixed list
            ...
            {validationErrors &&
              ...
              !validationErrors.password /*...etc*/ && (
                <Grid2 size={{ xs: 12 }}>
                  <Alert severity="error" sx={{ mt: 2 }}>
                    Error general al crear usuario. Verifique los campos.
                  </Alert>
                </Grid2>
              )}
          </Grid2>
