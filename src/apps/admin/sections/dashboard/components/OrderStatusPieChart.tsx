...
export const OrderStatusPieChart: React.FC<OrderStatusPieChartProps> = ({ orders, loading, title }) => {
    ...
    const chartData = useMemo(() => {
        ...
        return Object.entries(statusCounts).map(([englishKey, value]) => ({
            ...
            name: getSpanishOrderStatus(OrderStatus[englishKey as keyof typeof OrderStatus]),
            value: value,
        }));
