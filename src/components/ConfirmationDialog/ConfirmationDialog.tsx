...
const ConfirmationDialog: React.FC<ConfirmationDialogProps> = ({
    ...
    return (
        ...
        >
            ...
            <DialogActions sx={{ p: 2 }}> {/* Add some padding */}
                <Button onClick={onClose} color="secondary" disabled={isPerformingAction}>
                    {cancelText}
                </Button>
                <Button
                    onClick={onConfirm}
                    ...
                    startIcon={isPerformingAction ? <CircularProgress size={20} color="inherit" /> : null}
