...
// Types & API
import { Order, OrderStatus, GlobalPaymentStatus } from "@prixpon/types/order.types";
import {
  DashboardFilters,
          ...
          >
            ...
            <TabPanel value={activeTab} index={2}>
              <Grid2 container spacing={3}>
                ...
                <Grid2 size={{ xs: 12, xl: 6 }}>
                  <PerformanceWidget
                    title="Análisis por Línea de Producción"
                    data={productionLinePerformance}
                    loading={isRefetching}
                  />
                </Grid2>
              </Grid2>
                ...
                <Grid2 size={{ xs: 12, md: 6 }}>
                  <Paper variant="outlined" sx={{ p: 2, borderRadius: 2 }}>
                    <Typography variant="h6" fontWeight="bold" mb={1.5}>
                      Órdenes Pendientes de Pago ({pendingPaymentOrders.length})
                    </Typography>
                    <FilteredOrdersList
