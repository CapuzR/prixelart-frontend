  ...
  return (
    <>
          ...
          {imageLoader.loader && (
            <Grid style={{ display: 'flex', justifyContent: 'center' }}>
              <Grid lg={8} style={{ display: 'flex' }}>
                <img className={classes.imageLoad} src={imageLoader.loader} alt="Uploaded" />
                {/* {croppedArt.map(
                  (ar, index) =>
                    ar.id === tabValue && (
                      <Grid
                ...
                <Tooltip className={classes.buttonImgLoader} title="Eliminar imagen">
                              ...
                              >
                                ...
                                <DialogContent>
                                  <DialogContentText id="alert-dialog-description">
                                    Ésta imagen ya no se verá en el carrusel del banner principal
                                  </DialogContentText>
                                </DialogContent>
                                <DialogActions>
            ...
            <Box style={{ display: 'flex', justifyContent: 'center' }}>
              {props.permissions?.modifyBanners && (
                <FormControl>
                  ...
                  <Typography style={{ color: 'gray', marginBottom: 10 }}>
                    Te recomendamos usar imágenes de proporción 9:16, o al menos 4:3
                  </Typography>
                </FormControl>
              )}
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            Solo puedes agregar 6 imagenes al carrusel, procura eliminar algunas imagenes o
            reemplazar
          </DialogContentText>
        </DialogContent>
        <DialogActions>
