...
const UserData: React.FC<UserDataProps> = (props) => {
  ...
  const [prixerDataState, setPrixerDataState] = useState<"read" | "edit">(
    "read",
  );
          ...
          <>
            <Box style={{ textAlign: "end" }}>
              {JSON.parse(localStorage.getItem("token") || "null") &&
                JSON.parse(localStorage.getItem("token") || "null").username ===
                  username && (
                  <IconButton
                    title="Profile Edit"
                    color="primary"
                    ...
                    {avatarObj ? (
                      ...
                      >
                        <Avatar
                          ...
                          src={typeof profilePic === "string" ? profilePic : ""}
                  ...
                  >
                    <IconButton
                      ...
                      href={
                        ...
                        (instagram ? instagram.replace(/[@]/gi, "") : "")
                      }
                      style={{
                        textDecoration: "none",
