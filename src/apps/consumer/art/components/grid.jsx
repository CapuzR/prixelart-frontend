...
export default function Grid(props) {
  ...
  const [categoryValue, setCategoryValue] = useState(globalParams.get('category') || null);
    ...
    <div style={{ height: '100%', width: '100%' }}>
      <div className={classes.root}>
        <div style={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
          <SearchBar searchPhotos={handleSearch} searchValue={3} setSearchValue={setSearchValue} />
        </div>
      </div>
      <div
        style={{
