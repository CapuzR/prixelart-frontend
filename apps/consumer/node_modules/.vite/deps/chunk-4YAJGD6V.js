import {
  Tooltip_default
} from "./chunk-B2ES7W5Y.js";
import {
  Fab_default
} from "./chunk-K4ZVSMSC.js";
import {
  useSlot
...
var SpeedDialAction = React.forwardRef(function SpeedDialAction2(inProps, ref) {
  ...
  const fab = (0, import_jsx_runtime.jsx)(FabSlot, {
    ...fabSlotProps,
    children: icon
  });
  if (tooltipSlotProps.open) {
    return (0, import_jsx_runtime.jsxs)(StaticTooltipSlot, {
      ...staticTooltipSlotProps,
      ...other,
      children: [(0, import_jsx_runtime.jsx)(StaticTooltipLabelSlot, {
  ...
  return (0, import_jsx_runtime.jsx)(TooltipSlot, {
    ...tooltipSlotProps,
...
true ? SpeedDialAction.propTypes = {
   ...
   */
  tooltipPlacement: import_prop_types.default.oneOf(["auto-end", "auto-start", "auto", "bottom-end", "bottom-start", "bottom", "left-end", "left-start", "left", "right-end", "right-start", "right", "top-end", "top-start", "top"]),
  /**
...
//# sourceMappingURL=chunk-4YAJGD6V.js.map
