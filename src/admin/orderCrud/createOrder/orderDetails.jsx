...
export default function OrderDetails(props) {
  ...
  useEffect(() => {
    ...
    //   const state = await orderServices.updateSelectedOrder({
  ...
  const searchArt = async (searchValue) => {
    const artBase_url =
      process.env.REACT_APP_BACKEND_URL + "/art/read-by-query";
    const params = {
      text: searchValue,
    };
              ...
              <Grid container xs={12}>
                    ...
                    <Grid item xs={12} sm={12} md={4}>
                      ...
                      >
                        ...
                        <Select
                          ...
                          //     temp.prix[iPrix].product =
                          //       props.orderState.selectedOrder.products.filter(
                        ...
                        >
                          {/* {props.orderState.selectedOrder.products &&
                            props.orderState.selectedOrder.products.map(
                              (n, i, pArr) => (
                    ...
                    <Grid item spacing={2} xs={12} md={6}>
                      <Grid container spacing={2} xs={12} md={12}>
                        ...
                        {/* {prod.product.attributes &&
                          prod.product.attributes[0] &&
                          eval(prod.product.attributes[0]).length !== 0 &&
                          eval(prod.product.attributes[0]).map(
                            (att, iAtt, attributesArr) => (
                              <Grid
                                item
                                md={6 / (attributesArr.length - 1)}
                                xs={12}
                              >
                                <FormControl
                                  variant="outlined"
                    ...
                    <Grid item xs={12} md={12}>
                      ...
                      >
                        <Autocomplete
                          ...
                          //   options={
                          //     props.orderState.selectedOrder.prix[iPrix].arts
                          //   }
                          getOptionLabel={(option) => {
                          ...
                          //     const temp =
                          //       props.orderState.selectedOrder.prix[iPrix];
                              ...
                              <Paper elevation={3} style={{ minWidth: "100%" }}>
                                <Grid container spacing={2} xs={12}>
                                  ...
                                  >
                                    ...
                                    >
                                      {option.artId} | {option.title} -{" "}
                                      {option.prixerUsername}
                                    </Typography>
                                  </Grid>
                                </Grid>
                              </Paper>
                ...
                <Grid container xs={12} md={1}>
                  <Button
                    ...
                    //       .slice(0, iPrix)
                    //       .concat(props.selectedProduct.slice(iPrix + 1))
                    //   );
                    // }}
                  >
...

  {
    ...
    const { prix } = await orderServices.updateSelectedPrix({
      prix: props.orderState.selectedOrder.prix[iPrix],
      key: key,
      value: value,
    });
    const state = await orderServices.updateSelectedOrder({
