...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React8.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React8.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React8.useMemo(() => storageManager == null ? void 0 : storageManager({
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => React9.useContext(ColorSchemeContext) || defaultContext;
  ...
  function CssVarsProvider(props) {
    ...
    const initialTheme = React9.useMemo(() => {
      if (themeProp) {
        return themeProp;
      }
    ...
    const allColorSchemes = React9.useMemo(() => joinedColorSchemes.split(","), [joinedColorSchemes]);
    ...
    const memoTheme = React9.useMemo(() => {
      var _a2;
    ...
    const element = (0, import_jsx_runtime9.jsxs)(React9.Fragment, {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MGLQL3PC.js.map
