...
import {
  ...
  trimLines,
  trough
} from "./chunk-445M2QXK.js";
import {
  decodeNamedCharacterReference
} from "./chunk-UULPDIZR.js";
import {
  require_jsx_runtime
...
// ../../node_modules/style-to-js/node_modules/inline-style-parser/cjs/index.js
var require_cjs = __commonJS({
  "../../node_modules/style-to-js/node_modules/inline-style-parser/cjs/index.js"(exports, module) {
    "use strict";
    var COMMENT_REGEX = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//g;
    var NEWLINE_REGEX = /\n/g;
...
function developmentCreate(filePath, jsxDEV) {
  ...
  function create2(node2, type, props, key) {
    ...
    return jsxDEV(
      ...
      isStaticChildren,
      {
        columnNumber: point6 ? point6.column - 1 : void 0,
        fileName: filePath,
        lineNumber: point6 ? point6.line : void 0
      },
      void 0
    );
  }
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-util-symbol/lib/codes.js
var codes = (
  /** @type {const} */
  {
    carriageReturn: -5,
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-util-symbol/lib/constants.js
var constants = (
  /** @type {const} */
  {
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-util-symbol/lib/types.js
var types = (
  /** @type {const} */
  {
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-util-symbol/lib/values.js
var values = (
  /** @type {const} */
  {
    ht: "	",
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-util-chunked/dev/index.js
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-util-combine-extensions/index.js
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-util-decode-numeric-character-reference/dev/index.js
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-util-normalize-identifier/dev/index.js
function normalizeIdentifier(value) {
  return value.replace(/[\t\n\r ]+/g, values.space).replace(/^ | $/g, "").toLowerCase().toUpperCase();
}

// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-util-character/dev/index.js
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-factory-space/dev/index.js
  ...
  function documentContinue(code2) {
    ...
    if (self2.containerState._closeFlow) {
      ...
      while (index3 < self2.events.length) {
        self2.events[index3][1].end = { ...point6 };
        index3++;
      }
      splice(
        self2.events,
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-util-resolve-all/index.js
...
function tokenizeBlankLine(effects, ok4, nok) {
  ...
  function after(code2) {
    return code2 === codes.eof || markdownLineEnding(code2) ? ok4(code2) : nok(code2);
  }
}
...
function tokenizeFurtherStart(effects, ok4, nok) {
  ...
  function afterPrefix(code2) {
    const tail = self2.events[self2.events.length - 1];
    return tail && tail[1].type === types.linePrefix && tail[2].sliceSerialize(tail[1], true).length >= constants.tabSize ? ok4(code2) : markdownLineEnding(code2) ? furtherStart2(code2) : nok(code2);
  }
}
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-util-subtokenize/dev/lib/splice-buffer.js
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-util-subtokenize/dev/index.js
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-factory-destination/dev/index.js
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-factory-label/dev/index.js
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-factory-title/dev/index.js
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-factory-whitespace/dev/index.js
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-util-html-tag-name/index.js
var htmlBlockNames = [
  "address",
  "article",
  "aside",
...
function tokenizeLabelStartImage(effects, ok4, nok) {
  ...
  function after(code2) {
    return code2 === codes.caret && "_hiddenFootnoteSupport" in self2.parser.constructs ? nok(code2) : ok4(code2);
  }
}
...
function tokenizeIndent(effects, ok4, nok) {
  ...
  function afterPrefix(code2) {
    ok(self2.containerState, "expected state");
    const tail = self2.events[self2.events.length - 1];
    return tail && tail[1].type === types.listItemIndent && tail[2].sliceSerialize(tail[1], true).length === self2.containerState.size ? ok4(code2) : nok(code2);
  }
}
...
function tokenizeListItemPrefixWhitespace(effects, ok4, nok) {
  ...
  function afterPrefix(code2) {
    const tail = self2.events[self2.events.length - 1];
    return !markdownSpace(code2) && tail && tail[1].type === types.listItemPrefixWhitespace ? ok4(code2) : nok(code2);
  }
}
...
function createTokenizer(parser, initialize, from) {
  ...
  function now() {
    const { _bufferIndex, _index, line, column, offset } = point6;
  ...
  function consume(code2) {
    ...
    if (markdownLineEnding(code2)) {
      point6.line++;
      point6.column = 1;
      point6.offset += code2 === codes.carriageReturnLineFeed ? 2 : 1;
      accountForPotentialSkip();
    ...
    if (point6._bufferIndex < 0) {
      ...
      point6._bufferIndex++;
      if (point6._bufferIndex === // Points w/ non-negative `_bufferIndex` reference
      // strings.
      /** @type {string} */
      chunks[point6._index].length) {
...
// ../../node_modules/mdast-util-from-markdown/node_modules/micromark-util-decode-string/dev/index.js
...
// ../../node_modules/mdast-util-to-hast/node_modules/micromark-util-symbol/lib/codes.js
var codes2 = (
  /** @type {const} */
  {
    carriageReturn: -5,
...
// ../../node_modules/mdast-util-to-hast/node_modules/micromark-util-symbol/lib/values.js
var values2 = (
  /** @type {const} */
  {
    ht: "	",
...
// ../../node_modules/mdast-util-to-hast/node_modules/micromark-util-character/dev/index.js
...
var unicodePunctuation2 = regexCheck2(new RegExp("\\p{P}|\\p{S}", "u"));
...
// ../../node_modules/mdast-util-to-hast/node_modules/micromark-util-sanitize-uri/dev/index.js
function normalizeUri(value) {
  ...
  while (++index3 < value.length) {
    ...
    let replace = "";
    if (code2 === codes2.percentSign && asciiAlphanumeric2(value.charCodeAt(index3 + 1)) && asciiAlphanumeric2(value.charCodeAt(index3 + 2))) {
      skip = 2;
    } else if (code2 < 128) {
...
var pointEnd2 = point5("end");
var pointStart2 = point5("start");
...
function position4(node2) {
  const start2 = pointStart2(node2);
  const end = pointEnd2(node2);
  if (start2 && end) {
...
function table(state, node2) {
  ...
  if (rows.length > 0) {
    ...
    const start2 = pointStart2(node2.children[1]);
    const end = pointEnd2(node2.children[node2.children.length - 1]);
...
function visitParents(tree, test, visitor, reverse) {
  ...
  function factory(node2, index3, parents) {
    ...
    function visit3() {
      ...
      let offset;
      let grandparents;
      if (!test || is3(node2, index3, parents[parents.length - 1] || void 0)) {
...
// ../../node_modules/react-markdown/node_modules/unist-util-is/lib/index.js
var convert2 = (
  // Note: overloads in JSDoc can’t yet use different `@template`s.
  /**
   * @type {(
...
// ../../node_modules/react-markdown/node_modules/unist-util-visit-parents/lib/color.js
function color2(d) {
  return d;
}
