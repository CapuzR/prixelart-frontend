...
var Tab = React5.forwardRef(function Tab2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTab"
  });
  ...
  const icon = iconProp && label && React5.isValidElement(iconProp) ? React5.cloneElement(iconProp, {
  ...
  return (0, import_jsx_runtime5.jsxs)(TabRoot, {
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime5.jsxs)(React5.Fragment, {
      children: [icon, label]
...
//# sourceMappingURL=chunk-UKDDJ7QT.js.map
