        ...
        >
              ...
              >
                ...
                >
                    ...
                    <Grid item xs={8} sm={8} md={8} lg={8} xl={8} padding={10}>
                      ...
                      >
                        {['Prixer', 'Compañía', 'Cliente'].map((type) => (
                          <MenuItem key={type} value={type} style={getStyles(type, theme)}>
                            {type}
                          </MenuItem>
                        ))}
                      </Select>
                  ...
                  <Button
                    ...
                    paddingTop="4"
                    onClick={(event) =>
                      updateId ? saveChanges(event, updateId) : handleSubmit(event)
                    }
                  >
          ...
          <DragDropContext
            onDragEnd={(result) => {
              ...
              setTiles((tiles) => reorder(tiles, source.index, destination.index));
                                    ...
                                    <Grid marginBottom={2} style={{ width: '100%' }}>
                                      {props.permissions?.createTestimonial && (
                                        ...
                                        >
                                          ...
                                          {props.permissions?.deleteTestimonial && (
                                      ...
                                      {props.permissions?.createTestimonial && (
                                        ...
                                        >
                                          ...
                                          <Switch
                                            checked={tile.status}
                                            color="primary"
                                            onChange={(event) => ChangeVisibility(event, tile._id)}
                                            name="checkedA"
                                            inputProps={{
