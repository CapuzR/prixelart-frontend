...
export const createShippingMethod = async (
  ...
  try {
    ...
    if (!response.data.success) {
      console.error(
        "Backend reported failure creating shipping method:",
        response.data.message,
      );
      throw new Error(
        response.data.message || "Failed to create shipping method",
      );
    }

    if (!response.data.result) {
      console.error(
        "Backend reported success but no shipping method data was returned.",
      );
...
export const fetchShippingMethods = async (): Promise<ShippingMethod[]> => {
  ...
  try {
    ...
    if (!response.data.success) {
      console.error(
        "Backend reported failure fetching shipping methods:",
        response.data.message,
      );
      throw new Error(
        response.data.message || "Failed to fetch shipping methods",
      );
    }
    ...
    const shippingMethods =
      (response.data.result as unknown as ShippingMethod[]) || [];
...
export const fetchActiveShippingMethods = async (): Promise<
  ShippingMethod[]
> => {
...
export const getShippingMethodById = async (
  ...
  try {
    ...
    if (!response.data.success) {
      console.error(
        `Backend reported failure fetching shipping method '${id}':`,
        response.data.message,
      );
      // Consider if a 404 Not Found should be handled differently than a server error
      throw new Error(
        response.data.message || `Failed to fetch shipping method '${id}'`,
      );
    }
    ...
    if (!response.data.result) {
      ...
      console.error(
        `Backend reported success but no data for shipping method '${id}'.`,
      );
      throw new Error(
        `No data received for shipping method '${id}'. Could indicate the ID does not exist.`,
      );
    }
...
export const updateShippingMethod = async (
  ...
  try {
    ...
    if (!response.data.success) {
      console.error(
        `Backend reported failure updating shipping method '${id}':`,
        response.data.message,
      );
      throw new Error(
        response.data.message || `Failed to update shipping method '${id}'`,
      );
    }

    if (!response.data.result) {
      console.error(
        `Backend reported success but no shipping method data returned after update for '${id}'.`,
      );
      throw new Error(
        `No data received after updating shipping method '${id}'.`,
      );
    }

    // Cast the result to ShippingMethod
    const updatedShippingMethod = response.data
      .result as unknown as ShippingMethod;
...
export const deleteShippingMethod = async (
  ...
  try {
    ...
    if (!response.data.success) {
      console.error(
        `Backend reported failure deleting shipping method '${id}':`,
        response.data.message,
      );
      throw new Error(
        response.data.message || `Failed to delete shipping method '${id}'`,
      );
    }

    const deletedShippingMethod = response.data
      .result as unknown as ShippingMethod;
...
export const createPaymentMethod = async (
  ...
  try {
    ...
    if (!response.data.success) {
      console.error(
        "Backend reported failure creating payment method:",
        response.data.message,
      );
      throw new Error(
        response.data.message || "Failed to create payment method",
      );
    }

    if (!response.data.result) {
      console.error(
        "Backend reported success but no payment method data was returned.",
      );
...
export const readAllPaymentMethods = async (): Promise<PaymentMethod[]> => {
  ...
  try {
    ...
    if (!response.data.success) {
      console.error(
        "Backend reported failure fetching payment methods:",
        response.data.message,
      );
      throw new Error(
    ...
    const paymentMethods =
      (response.data.result as unknown as PaymentMethod[]) || [];
...
export const readAllActivePaymentMethods = async (): Promise<
  PaymentMethod[]
> => {
...
export const getPaymentMethodById = async (
  ...
  try {
    ...
    if (!response.data.success) {
      console.error(
        `Backend reported failure fetching payment method '${id}':`,
        response.data.message,
      );
      throw new Error(
        response.data.message || `Failed to fetch payment method '${id}'`,
      );
    }

    if (!response.data.result) {
      console.error(
        `Backend reported success but no data for payment method '${id}'.`,
      );
...
export const updatePaymentMethod = async (
  ...
  try {
    ...
    if (!response.data.success) {
      console.error(
        `Backend reported failure updating payment method '${id}':`,
        response.data.message,
      );
      throw new Error(
        response.data.message || `Failed to update payment method '${id}'`,
      );
    }

    if (!response.data.result) {
      console.error(
        `Backend reported success but no payment method data returned after update for '${id}'.`,
      );
      throw new Error(
        `No data received after updating payment method '${id}'.`,
      );
    }

    // Cast the result to PaymentMethod
    const updatedPaymentMethod = response.data
      .result as unknown as PaymentMethod;
...
export const deletePaymentMethod = async (
  ...
  try {
    ...
    if (!response.data.success) {
      console.error(
        `Backend reported failure deleting payment method '${id}':`,
        response.data.message,
      );
      throw new Error(
        response.data.message || `Failed to delete payment method '${id}'`,
      );
    }
    ...
    if (!response.data.result) {
      ...
      console.warn(
        `Backend reported success deleting payment method '${id}' but returned no data.`,
      );
    ...
    const deletedPaymentMethod = response.data
      .result as unknown as PaymentMethod;
...
export const getOrderById = async (id: string): Promise<Order> => {
  ...
  try {
    ...
    if (!response.data.success) {
      console.error(
        `Backend reported failure fetching order '${id}':`,
        response.data.message,
      );
...
export const updateOrder = async (
  ...
  try {
    ...
    if (!response.data.success) {
      console.error(
        `Backend reported failure updating order '${id}':`,
        response.data.message,
      );
      throw new Error(
        response.data.message || `Failed to update order '${id}'`,
      );
    }

    if (!response.data.result) {
      console.error(
        `Backend reported success but no order data returned after update for '${id}'.`,
      );
...
export const deleteOrder = async (id: string): Promise<Order> => {
  const base_url = import.meta.env.VITE_BACKEND_URL + "/order/delete/" + id;
  try {
...
export interface DashboardFilters {
  // This can be a shared type
  startDate: Date;
  endDate: Date;
}

export const fetchGlobalOrdersList = async (
  ...
  try {
    ...
    if (!response.data.success || !response.data.result) {
      console.error(
        `Backend error fetching global orders:`,
        response.data.message,
      );
    ...
    if (axios.isAxiosError(error) && error.response) {
      throw new Error(
        error.response.data?.message ||
          "Failed to fetch global orders due to server error.",
      );
    }
    throw error;
  }
 ...
 */
export const fetchGlobalDashboardStats = async (
  filters: DashboardFilters,
): Promise<GlobalDashboardStatsData> => {
  ...
  try {
    ...
    if (!response.data.success || !response.data.result) {
      console.error(
        `Backend error fetching global dashboard stats:`,
        response.data.message,
      );
      throw new Error(
        response.data.message || `Failed to fetch global dashboard stats`,
      );
    }
    ...
    if (axios.isAxiosError(error) && error.response) {
      throw new Error(
        error.response.data?.message ||
          "Failed to fetch global dashboard stats due to server error.",
      );
    }
    throw error;
  }
...
export const fetchGlobalTopPerformingItems = async (
  ...
  try {
    ...
    if (!response.data.success || !response.data.result) {
      console.error(
        `Backend error fetching global top items:`,
        response.data.message,
      );
      throw new Error(
        response.data.message || `Failed to fetch global top items`,
      );
    }
    ...
    if (axios.isAxiosError(error) && error.response) {
      throw new Error(
        error.response.data?.message ||
          "Failed to fetch global top items due to server error.",
      );
    }
    throw error;
  }
...
export const fetchProductionLinePerformance = async (
  ...
  if (data.success && Array.isArray(data.result)) {
    ...
    throw new Error(
      data.message || "Failed to fetch production line performance",
    );
  }
};
