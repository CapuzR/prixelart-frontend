...
import { CardActionArea, Typography, IconButton, Tooltip, Box } from '@mui/material';
...
export default function ArtThumbnail({
  ...
  return (
    <div style={{ marginBottom: '7px', borderRadius: '4px', overflow: 'hidden' }}>
      ...
      >
        ...
        {/* Overlaid Icons */}
        <Box sx={{ position: 'absolute', top: 0, left: 0, width: '100%', p: 0.5 }}>
          {!onArtSelect && (
