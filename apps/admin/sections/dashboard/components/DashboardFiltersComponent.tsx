...
export const DashboardFiltersComponent: React.FC<DashboardFiltersProps> = ({
  ...
  const predefinedRanges = [
    {
      label: "Hoy",
      value: "today" as PredefinedRange,
      range: (): [Date, Date] => [new Date(), new Date()],
    },
    {
      label: "Últimos 7 días",
      value: "last7" as PredefinedRange,
      range: (): [Date, Date] => [subDays(new Date(), 6), new Date()],
    },
    {
      label: "Últimos 30 días",
      value: "last30" as PredefinedRange,
      range: (): [Date, Date] => [subDays(new Date(), 29), new Date()],
    },
    {
      label: "Mes en curso",
      value: "thisMonth" as PredefinedRange,
      range: (): [Date, Date] => [startOfMonth(new Date()), new Date()],
    },
  ];
      ...
      >
        ...
        {predefinedRanges.map((pRange) => (
          <Button
            ...
            onClick={() =>
              handlePredefinedRangeClick(pRange.value, pRange.range)
            }
            disabled={loading}
          >
            {pRange.label}
