...
import {
  ...
  CircularProgress, Alert, Stack, FormHelperText // Added FormHelperText
} from '@mui/material';
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response) {
        ...
        throw new Error("La creación del método de pago no devolvió una respuesta esperada.");
      }
    } catch (err: any) {
      ...
      <Paper elevation={3} sx={{ p: 3, mt: 2 }}>
        <form onSubmit={handleSubmit} noValidate> {/* Added noValidate */}
          <Grid2 container spacing={3}>
            ...
            {validationErrors && validationErrors.name && validationErrors.name !== "El nombre del método de pago es obligatorio." && (
