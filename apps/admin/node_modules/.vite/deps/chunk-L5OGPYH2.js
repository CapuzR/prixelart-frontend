...
var ToggleButtonGroupContext = React2.createContext({});
if (true) {
...
var ToggleButtonGroupButtonContext = React3.createContext(void 0);
if (true) {
...
var ToggleButton = React4.forwardRef(function ToggleButton2(inProps, ref) {
  const {
    value: contextValue,
    ...contextProps
  } = React4.useContext(ToggleButtonGroupContext_default);
  const toggleButtonGroupButtonContextPositionClassName = React4.useContext(ToggleButtonGroupButtonContext_default);
  ...
  return (0, import_jsx_runtime2.jsx)(ToggleButtonRoot, {
...
true ? ToggleButton.propTypes = {
   ...
   * @default 'standard'
   */
  color: import_prop_types2.default.oneOfType([import_prop_types2.default.oneOf(["standard", "primary", "secondary", "error", "info", "success", "warning"]), import_prop_types2.default.string]),
  /**
...
//# sourceMappingURL=chunk-L5OGPYH2.js.map
