        ...
        <form onSubmit={handleSubmit} className={classes.form} noValidate>
              ...
              <FormControl className={classes.formControl} style={{ width: '100%' }}>
                ...
                >
                  {specialties.map((specialty) => (
                    <MenuItem key={specialty} value={specialty} style={getStyles(specialty, theme)}>
                      {specialty}
                    </MenuItem>
                  ))}
                </Select>
          ...
          >
            <FormControlLabel
              ...
              control={<Checkbox color="primary" value={isChecked} checked={isChecked} />}
              label="Acepto los"
            ...
            <Modal open={modal} onClose={openModal} xl={800} lg={800} md={480} sm={360} xs={360}>
              {body}
            </Modal>
          </Grid>
          <Button
