                ...
                <div>
                  <List component="div" disablePadding>
                    ...
                    >
                      ...
                      >
                        {checkoutState.order.billing?.method ===
                          "Balance Prixer" && (
                          <div
                            style={{
                          ...
                          >
                            {currency
                              ? "Saldo disponible: Bs" +
                                (balance * conversionRate).toLocaleString(
                                  "de-DE",
                                  {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2,
                        ...
                        <strong>
                          ...
                          {currency === "Bs"
                            ? (
                                checkoutState.order.subTotal * conversionRate
                              ).toLocaleString("de-DE", {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2,
                              })
                            : checkoutState.order.subTotal.toLocaleString(
                                "de-DE",
                                {
                                  minimumFractionDigits: 2,
                                  maximumFractionDigits: 2,
                        ...
                        {checkoutState.shipping.method &&
                          typeof checkoutState.order.shippingCost !==
                            "undefined" &&
                          (currency === "Bs" ? (
                            <strong>
                              {`Envío: Bs${(
                                checkoutState.order.shippingCost *
                                conversionRate
                              ).toLocaleString("de-DE", {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2,
                            ...
                            <strong>
                              {`Envío: $${checkoutState.order.shippingCost.toLocaleString(
                                "de-DE",
                                {
                                  minimumFractionDigits: 2,
                                  maximumFractionDigits: 2,
                        ...
                        <strong>
                          ...
                          {currency === "Bs"
                            ? (
                                checkoutState.order.total * conversionRate
                              ).toLocaleString("de-DE", {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2,
                              })
                            : checkoutState.order.total.toLocaleString(
                                "de-DE",
                                {
                                  minimumFractionDigits: 2,
                                  maximumFractionDigits: 2,
