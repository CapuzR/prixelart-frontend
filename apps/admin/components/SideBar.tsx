    ...
    >
      <List component="nav" aria-labelledby="admin-sidebar-nav">
                ...
                {canViewAdmins && (
                  <>
                    <ListItemButton
                      ...
                      sx={listItemStyle("/admin/admins/create")}
                    >
                      <ListItemIcon>
                    ...
                    <ListItemButton
                      component={RouterLink}
                      to="/admin/admins/read"
                      sx={listItemStyle("/admin/admins/read")}
                    >
                      <ListItemIcon>
                    ...
                    <ListItemButton
                      component={RouterLink}
                      to="/admin/admins/roles/create"
                      sx={listItemStyle("/admin/admins/roles/create")}
                    >
                      <ListItemIcon>
                    ...
                    <ListItemButton
                      component={RouterLink}
                      to="/admin/admins/roles/read"
                      sx={listItemStyle("/admin/admins/roles/read")}
                    >
                      <ListItemIcon>
              ...
              <List component="div" disablePadding>
                {permissions.products.createProduct && (
                  <ListItemButton
                    ...
                    sx={listItemStyle("/admin/product/create")}
                  >
                    <ListItemIcon>
                      <AddIcon fontSize="small" />
                    </ListItemIcon>
                ...
                {permissions.products.readAllProducts && (
                  <ListItemButton
                    component={RouterLink}
                    to="/admin/product/read"
                    sx={listItemStyle("/admin/product/read")}
                  >
                    <ListItemIcon>
                      <ListAltIcon fontSize="small" />
                    </ListItemIcon>
        ...
        {canViewArt && (
          <>
            <ListItemButton
              onClick={() => onSectionClick("art")}
              sx={sectionHeaderStyle("/admin/art")}
            >
              <ListItemIcon>
                <BrushIcon />
              </ListItemIcon>
            ...
            <Collapse in={openSections.art} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                {permissions.art.createArt && (
                  <ListItemButton
                    component={RouterLink}
                    to="/admin/art/create"
                    sx={listItemStyle("/admin/art/create")}
                  >
                    <ListItemIcon>
                      <AddIcon fontSize="small" />
                    </ListItemIcon>
                ...
                {permissions.art.readAllArts && (
                  <ListItemButton
                    component={RouterLink}
                    to="/admin/art/read"
                    sx={listItemStyle("/admin/art/read")}
                  >
                    <ListItemIcon>
                      <ListAltIcon fontSize="small" />
                    </ListItemIcon>
        ...
        {canViewDiscounts && (
          <>
            <ListItemButton
              onClick={() => onSectionClick("discounts")}
              sx={sectionHeaderStyle("/admin/discount")}
            >
              <ListItemIcon>
                <DiscountIcon />
              </ListItemIcon>
              ...
              <List component="div" disablePadding>
                {permissions.discounts.createDiscount && (
                  <ListItemButton
                    ...
                    sx={listItemStyle("/admin/discount/create")}
                  >
                ...
                {permissions.discounts.readAllDiscounts && ( // Use a specific read permission if available
                  <ListItemButton
                    component={RouterLink}
                    to="/admin/discount/read"
                    sx={listItemStyle("/admin/discount/read")}
                  >
                    <ListItemIcon>
                      <ListAltIcon fontSize="small" />
                    </ListItemIcon>
        ...
        {canViewSurcharges && (
          <>
            <ListItemButton
              onClick={() => onSectionClick("surcharges")}
              sx={sectionHeaderStyle("/admin/surcharges")}
            >
              <ListItemIcon>
                <PriceChangeIcon />
              </ListItemIcon>
            ...
            <Collapse in={openSections.surcharges} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                {permissions.surcharges.createSurcharge && (
                  <ListItemButton
                    component={RouterLink}
                    to="/admin/surcharges/create"
                    sx={listItemStyle("/admin/surcharges/create")}
                  >
                    {/* Keep original path for create or update */}
                    <ListItemIcon>
                      <AddIcon fontSize="small" />
                ...
                {permissions.surcharges.readAllSurcharges && (
                  <ListItemButton
                    component={RouterLink}
                    to="/admin/surcharges/read"
                    sx={listItemStyle("/admin/surcharges/read")}
                  >
                    <ListItemIcon>
                      <ListAltIcon fontSize="small" />
                    </ListItemIcon>
        ...
        {canViewConsumers && (
          <>
            ...
            <Collapse in={openSections.consumers} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                {permissions.users.createConsumer && (
                  <ListItemButton
                    component={RouterLink}
                    to="/admin/users/create"
                    sx={listItemStyle("/admin/users/create")}
                  >
                    <ListItemIcon>
                      <AddIcon fontSize="small" />
                    </ListItemIcon>
                ...
                {permissions.users.readAllUsers && (
                  <ListItemButton
                    component={RouterLink}
                    to="/admin/users/read"
                    sx={listItemStyle("/admin/users/read")}
                  >
                    <ListItemIcon>
                      <ListAltIcon fontSize="small" />
                    </ListItemIcon>
        ...
        <>
          <ListItemButton
            ...
            sx={sectionHeaderStyle("/admin/orders")}
          >
            <ListItemIcon>
              <ReceiptIcon />
            </ListItemIcon>
            ...
            <List component="div" disablePadding>
              {permissions.orders.create && (
                <ListItemButton
                  ...
                  sx={listItemStyle("/admin/orders/create")}
                >
                  <ListItemIcon>
                    <AddIcon fontSize="small" />
                  </ListItemIcon>
              ...
              <ListItemButton
                component={RouterLink}
                to="/admin/orders/read"
                sx={listItemStyle("/admin/orders/read")}
              >
                <ListItemIcon>
                  <ListAltIcon fontSize="small" />
                </ListItemIcon>
        ...
        <>
          <ListItemButton
            ...
            sx={sectionHeaderStyle("/admin/orderArchives/*")}
          >
            <ListItemIcon>
              <ManageSearchIcon />
            </ListItemIcon>
        ...
        {canViewShipping && (
          <>
            <ListItemButton
              onClick={() => onSectionClick("shipping")}
              sx={sectionHeaderStyle("/admin/shipping-method")}
            >
              <ListItemIcon>
                <LocalShippingIcon />
              </ListItemIcon>
            ...
            <Collapse in={openSections.shipping} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                {permissions.shippingMethod.createShippingMethod && (
                  <ListItemButton
                    component={RouterLink}
                    to="/admin/shipping-method/create"
                    sx={listItemStyle("/admin/shipping-method/create")}
                  >
                    <ListItemIcon>
                      <AddIcon fontSize="small" />
                    </ListItemIcon>
                ...
                {permissions.shippingMethod.readAllShippingMethod && (
                  <ListItemButton
                    ...
                    sx={listItemStyle("/admin/shipping-method/read")}
                  >
                    <ListItemIcon>
                      <ListAltIcon fontSize="small" />
                    </ListItemIcon>
        ...
        {canViewPayments && (
          <>
            <ListItemButton
              ...
              sx={sectionHeaderStyle("/admin/payment-method")}
            >
              <ListItemIcon>
                <PaymentIcon />
              </ListItemIcon>
            ...
            <Collapse in={openSections.payments} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                {permissions.paymentMethods.createPaymentMethod && (
                  <ListItemButton
                    component={RouterLink}
                    to="/admin/payment-method/create"
                    sx={listItemStyle("/admin/payment-method/create")}
                  >
                    <ListItemIcon>
                      <AddIcon fontSize="small" />
                    </ListItemIcon>
                ...
                {permissions.paymentMethods.readAllPaymentMethod && (
                  <ListItemButton
                    ...
                    sx={listItemStyle("/admin/payment-method/read")}
                  >
                    <ListItemIcon>
                      <ListAltIcon fontSize="small" />
                    </ListItemIcon>
        ...
        {canViewMovements && (
          <>
            <ListItemButton
              onClick={() => onSectionClick("movements")}
              sx={sectionHeaderStyle("/admin/movements")}
            >
              <ListItemIcon>
                <AccountBalanceIcon />
              </ListItemIcon>
            ...
            <Collapse in={openSections.movements} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                {permissions.movements.createMovement && ( // Check for create permission
                  <ListItemButton
                    component={RouterLink}
                    to="/admin/movements/create"
                    sx={listItemStyle("/admin/movements/create")}
                  >
                    <ListItemIcon>
                      <AddIcon fontSize="small" />
                    </ListItemIcon>
                ...
                {permissions.movements.readAllMovements && ( // Check for read permission
                  <ListItemButton
                    component={RouterLink}
                    to="/admin/movements/read"
                    sx={listItemStyle("/admin/movements/read")}
                  >
                    <ListItemIcon>
                      <ListAltIcon fontSize="small" />
                    </ListItemIcon>
        ...
        {canViewTestimonials && (
          <>
            <ListItemButton
              ...
              sx={sectionHeaderStyle("/admin/testimonials")}
            >
              <ListItemIcon>
                <InsertEmoticonIcon />
              </ListItemIcon>
            ...
            <Collapse
              in={openSections.testimonials}
              timeout="auto"
              unmountOnExit
            >
              <List component="div" disablePadding>
                {permissions.testimonials.createTestimonial && (
                  <ListItemButton
                    component={RouterLink}
                    to="/admin/testimonials/create"
                    sx={listItemStyle("/admin/testimonials/create")}
                  >
                    <ListItemIcon>
                      <AddIcon fontSize="small" />
                    </ListItemIcon>
                ...
                {permissions.testimonials.readTestimonials && (
                  <ListItemButton
                    ...
                    sx={listItemStyle("/admin/testimonials/read")}
                  >
                    <ListItemIcon>
                      <ListAltIcon fontSize="small" />
                    </ListItemIcon>
        ...
        {canViewPreferencesSection && (
          <>
            <ListItemButton
              ...
              sx={sectionHeaderStyle("/admin/preferences")}
            >
              <ListItemIcon>
                <SettingsIcon />
              </ListItemIcon>
            ...
            <Collapse
              in={openSections.preferences}
              timeout="auto"
              unmountOnExit
            >
              <List component="div" disablePadding>
                {/* Item 1: Banners/Carousel */}
                {permissions.preferences.readAllBanners && ( // Specific permission check
                  <ListItemButton
                    component={RouterLink}
                    to="/admin/preferences/banners"
                    sx={listItemStyle("/admin/preferences/banners")}
                  >
                    {/* Adjusted path */}
                    <ListItemIcon>
                ...
                {permissions.preferences.updateTermsAndCo && ( // Specific permission check
                  <ListItemButton
                    component={RouterLink}
                    to="/admin/preferences/terms"
                    sx={listItemStyle("/admin/preferences/terms")}
                  >
                    {/* New path */}
                    <ListItemIcon>
                ...
                {/* Item 3: Dollar Value */}
                {permissions.preferences.updateDollarValue && ( // Specific permission check
                  <ListItemButton
                    component={RouterLink}
                    to="/admin/preferences/dollar"
                    sx={listItemStyle("/admin/preferences/dollar")}
                  >
                    {/* New path */}
                    <ListItemIcon>
