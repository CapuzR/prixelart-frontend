...
export const Track: React.FC<TrackProps> = ({
  ...
  const slideWidthPercentage = isSlidingActive
    ...
    : numChildren > 0
      ? 100 / numChildren
      : 100; // Distribute items evenly if not sliding, or 100% if 0 items (edge case)
  ...
  return (
    <div className={`${styles["slider-container"]}`}>
      <div
        ...
        style={{
          transform: isSlidingActive
            ? `translateX(-${currentIndex * (100 / qtyPerSlide)}%)`
            : "translateX(0%)",
          transition: isSlidingActive
